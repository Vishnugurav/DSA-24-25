...
int main(){
    ...
    insert(&mylinklist, 1 , 13);
    insert(&mylinklist, 2 , 6);
    insert(&mylinklist, 1 , 28);
...
// inserting value in linklist2;
    ...
    sortedinsert(&linklist1, 10);
    sortedinsert(&linklist1, 28);
    sortedinsert(&linklist1, 13);
    printf("sorted insert sucess fully\n");
    display(linklist1);
